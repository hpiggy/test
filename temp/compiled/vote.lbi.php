...
?>
    ...
    foreach ($_from AS $this->_var['title']):
?>
          <?php $_from = $this->_var['title']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_39159900_1469431448');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_39159900_1469431448']):
?>
            <?php if ($this->_var['title']['can_multi'] == 0): ?>
            <input type="checkbox" name="option_id" value="<?php echo $this->_var['item_0_39159900_1469431448']['option_id']; ?>" />
            <?php echo $this->_var['item_0_39159900_1469431448']['option_name']; ?> (<?php echo $this->_var['item_0_39159900_1469431448']['percent']; ?>%)<br />
            <?php else: ?>
            <input type="radio" name="option_id" value="<?php echo $this->_var['item_0_39159900_1469431448']['option_id']; ?>" />
            <?php echo $this->_var['item_0_39159900_1469431448']['option_name']; ?> (<?php echo $this->_var['item_0_39159900_1469431448']['percent']; ?>%)<br />
            <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
