<?php echo $this->fetch('library/page_header.lbi'); ?><style>
...
?>
  ...
  <?php endif; ?> 
</div><?php echo $this->fetch('library/search.lbi'); ?><?php echo $this->fetch('library/page_footer.lbi'); ?><script type="text/javascript">
