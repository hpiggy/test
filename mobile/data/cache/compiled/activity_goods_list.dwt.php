...
<div style="height:7.2em;"></div>
  ...
  </header><?php echo $this->fetch('library/goods_list_act.lbi'); ?></div><?php echo $this->fetch('library/search.lbi'); ?><?php echo $this->fetch('library/page_footer.lbi'); ?><script type="text/javascript">
