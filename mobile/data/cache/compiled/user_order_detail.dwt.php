...
<section class="user-order-detail" style="border-top:none; margin-top:1em;">
...
?>
  ...
  <?php if ($this->_var['order']['order_amount'] > 0): ?>
	<section class="ect-padding-lr ect-padding-tb" style="margin:0;"><?php echo $this->_var['order']['pay_online']; ?></section>
  <?php endif; ?>
  <div class="panel panel-default" style="margin-bottom:0;">
  	<div class="panel-heading">
          ...
          <div class="panel-body">
          	<div class="ect-pro-list" style="border-top:0;">
    <ul>
      <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
      <li style=""><a href="<?php echo url('goods/index', array('id'=>$this->_var['goods']['goods_id']));?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>"></a>
        <dl>
          <dt>
...
<div class="two-btn ect-padding-tb ect-padding-lr ect-margin-tb text-center"> <?php echo $this->_var['order']['handler']; ?> 
  <?php if ($this->_var['order']['shipping_id'] > 0): ?><a class="btn btn-info ect-bg-colory" type="button" href="<?php echo url('order_tracking', array('order_id'=>$this->_var['order']['order_id']));?>"><?php echo $this->_var['lang']['order_tracking']; ?></a><?php endif; ?> 
</div>
...
<div class="user-order-detail" style="border-top:none !important;">
<div class="panel panel-default">
	<div class="panel-heading">
		    <h3 class="panel-title"><?php echo $this->_var['lang']['use_more_surplus']; ?></h3>
		  </div>
     <div class="panel-body">
 <?php if ($this->_var['allow_edit_surplus']): ?>
    ...
    <section class="order-detail-info ect-margin-tb" style="border-top:none; margin-top:0;">
        <ul><li style="border:none;"><span><input name="surplus" class="ect-padding-lr" type="text" size="8" value="0" /></span>
...
<section class="order-detail-info ect-margin-tb  ect-margin-bottom0">
  <ul>
   ...
   <?php if ($this->_var['order']['shipping_id'] > 0): ?>
    ...
    <?php endif; ?>
    <li style="border:none;"><?php echo $this->_var['lang']['booking_process']; ?>：<b><?php echo $this->_var['order']['how_oos_name']; ?></b></li>
  </ul>
</section>
</div>
</div>
