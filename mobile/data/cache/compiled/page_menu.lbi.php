<ul class="ect-diaplay-box text-center">
  ...
  <li class="ect-box-flex"><a href="<?php echo url('category/top_all');?>"><i class="icon-cate"></i><?php echo $this->_var['lang']['category']; ?></a></li>
  <li class="ect-box-flex"><a href="<?php echo url('user/order_list');?>"><i class="ect-icon ect-icon-cate"></i><?php echo $this->_var['lang']['label_order']; ?></a></li>
